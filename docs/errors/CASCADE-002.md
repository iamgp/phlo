...
**Severity:** High
**Exception Class:** `CascadeSchemaError`
...
Cascade provides helpful suggestions when it detects a typo:
...
- [CASCADE-001: Asset Not Discovered](./CASCADE-001.md) - Asset import issues
- [CASCADE-005: Missing Schema](./CASCADE-005.md) - Schema not provided
- [CASCADE-200: Schema Conversion Error](./CASCADE-200.md) - Pandera → PyIceberg conversion fails
...
1. **Use constants for field names**
   ...
   # ingestion/weather.py
   from cascade.schemas.weather import WeatherObservations, UNIQUE_KEY
...
- [Cascade Schema Guide](../TESTING_GUIDE.md#schema-definitions)
