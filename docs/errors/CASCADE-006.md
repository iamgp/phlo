...
**Severity:** High
**Exception Class:** `CascadeIngestionError`
...
- [CASCADE-008: Infrastructure Error](./CASCADE-008.md) - Infrastructure services unavailable
- [CASCADE-300: DLT Pipeline Failed](./CASCADE-300.md) - DLT-specific ingestion errors
- [CASCADE-004: Validation Failed](./CASCADE-004.md) - Data validation errors
