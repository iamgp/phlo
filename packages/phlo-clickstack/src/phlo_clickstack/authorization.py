...
class ClickStackPrincipalResolver:
    """Resolves principal from execution environment for ClickStack CLI.
    ...
    def resolve() -> AuthPrincipal:
        ...
        if local_dev_fallback:
            logger.warning(
                "clickstack_cli_authorization_dev_fallback",
...
class ClickStackSurfaceAdapter:
    ...
    def __init__(self) -> None:
        self._resolver = ClickStackPrincipalResolver()
