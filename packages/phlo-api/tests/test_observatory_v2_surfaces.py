"""Tests for concrete Observatory v2 API surfaces."""
...
from phlo_api.observatory_api import v2_runs


def test_v2_runs_adapter_normalizes_legacy_dagster_runs(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(v2_runs, "_load_legacy_dagster_runs", lambda: fake_get_runs())

    runs = v2_runs.load_runs()
