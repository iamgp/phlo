...
class ClickHousePrincipalResolver:
    """Resolves principal from execution environment for ClickHouse CLI.
    ...
    def resolve() -> AuthPrincipal:
        ...
        if local_dev_fallback:
            logger.warning(
                "clickhouse_cli_authorization_dev_fallback",
...
class ClickHouseSurfaceAdapter:
    ...
    def __init__(self) -> None:
        self._resolver = ClickHousePrincipalResolver()
