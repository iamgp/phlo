...
from phlo.api.observatory_api.trino import (
    DEFAULT_CATALOG,
    QueryExecutionError,
    execute_trino_query,
    quote_identifier,
...
async def get_tables(
    ...
    # TODO: Add caching
    return await fetch_tables(branch, effective_catalog, preferred_schema, trino_url, timeout_ms)
...
async def get_table_schema(
    ...
    return await fetch_table_schema(
