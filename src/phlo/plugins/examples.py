...
class WeatherAPIConnector(SourceConnectorPlugin):
    ...
    ```toml
    [project.entry-points."phlo.plugins.sources"]
    weather_api = "my_phlo_plugin:WeatherAPIConnector"
    ```
    ...
    def metadata(self) -> PluginMetadata:
        return PluginMetadata(
            ...
            author="Phlo Community",
            license="MIT",
            homepage="https://github.com/phlo-community/weather-api-connector",
...
class SequentialIDCheckPlugin(QualityCheckPlugin):
    ...
    sequential_id = "my_phlo_plugin:SequentialIDCheckPlugin"
    ```
...
class PivotTransform(TransformationPlugin):
    ...
    pivot = "my_phlo_plugin:PivotTransform"
    ```
...
[project.entry-points."phlo.plugins.sources"]
weather_api = "my_phlo_plugin.connectors:WeatherAPIConnector"
stock_api = "my_phlo_plugin.connectors:StockAPIConnector"

[project.entry-points."phlo.plugins.quality"]
sequential_id = "my_phlo_plugin.quality:SequentialIDCheckPlugin"
...
## __init__.py:
```python
from my_phlo_plugin.connectors import WeatherAPIConnector, StockAPIConnector
from my_phlo_plugin.quality import SequentialIDCheckPlugin
from my_phlo_plugin.transforms import PivotTransform
