...
"""
    ...
    def _render_env(
        ...
        *,
        ...
        overrides = self._normalize_env_overrides(env_overrides or {})
        ...
        for category, vars_list in categories.items():
            ...
            for var_name, var_config in vars_list:
                ...
                value = overrides.get(var_name, self._normalize_env_value(default))
...
"""
    ...
    def _normalize_env_overrides(self, env_overrides: dict[str, Any]) -> dict[str, str]:
        normalized: dict[str, str] = {}
        for key, value in env_overrides.items():
            if not isinstance(key, str):
                continue
            normalized[key] = self._normalize_env_value(value)
        return normalized
