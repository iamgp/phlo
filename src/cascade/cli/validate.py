...
def validate_schema(
    ...
    Examples:
      # Validate a schema
      cascade validate-schema src/cascade/schemas/weather.py

      # Validate without checking descriptions
      cascade validate-schema src/cascade/schemas/weather.py --no-check-descriptions
    """
...
def validate_workflow(asset_file: str):
    ...
    \b
    Examples:
      cascade validate-workflow src/cascade/defs/ingestion/weather/observations.py
    """
