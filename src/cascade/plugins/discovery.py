...
that declare cascade.plugins entry points.
"""
...
from cascade.plugins.registry import get_global_registry

logger = logging.getLogger(__name__)

# Entry point group names for different plugin types
ENTRY_POINT_GROUPS = {
    "source_connectors": "cascade.plugins.sources",
    "quality_checks": "cascade.plugins.quality",
    "transformations": "cascade.plugins.transforms",
}
...
def discover_plugins(
    ...
    This function scans installed Python packages for cascade.plugins
...
def auto_discover() -> None:
    ...
    This function is called automatically when cascade is imported.
