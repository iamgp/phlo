# PublishEventEmitter (/docs/python-reference/core/phlo/hooks/emitters/PublishEventEmitter)
...
<PyFunction name="&#x22;__init__&#x22;" type="&#x22;(self, context, hook_bus=None) -> None&#x22;">
  ...
  <div>
    ...
    <PyParameter name="&#x22;context&#x22;" type="&#x22;PublishEventContext&#x22;" value="undefined">
      Shared publish context to include in each emitted event.
    </PyParameter>
