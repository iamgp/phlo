# MinIOCompiler (/docs/python-reference/core/phlo/rbac/compiler/MinIOCompiler)
...
<PyAttribute name="&#x22;ACTION_MAPPING&#x22;" type="&#x22;dict[str, list[str]]&#x22;" value="&#x22;{'object.read': ['s3:GetObject', 's3:ListBucket'], 'object.write': ['s3:PutObject', 's3:DeleteObject']}&#x22;" />
