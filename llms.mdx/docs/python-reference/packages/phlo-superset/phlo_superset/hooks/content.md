# hooks (/docs/python-reference/packages/phlo-superset/phlo_superset/hooks)
...
> > > from phlo\_superset.hooks import add\_query\_engine\_database
> > > add\_query\_engine\_database()

<PyAttribute name="&#x22;logger&#x22;" type="null" value="&#x22;get_logger(__name__)&#x22;" />

<Tabs items="[&#x22;Functions&#x22;]">
  <Tab value="&#x22;Functions&#x22;">
    <PyFunction name="&#x22;_superset_auth_provider&#x22;" type="&#x22;() -> str&#x22;">
      ...
      <Callout title="&#x22;Example&#x22;" type="&#x22;example&#x22;">
        > > > provider = \_superset\_auth\_provider()
        > > > print(provider)
        > > > 'db'
      </Callout>

      <Callout title="&#x22;Environment&#x22;" type="&#x22;environment&#x22;">
        SUPERSET\_AUTH\_PROVIDER: The auth provider name (default: 'db').
      </Callout>
    ...
    <PyFunction name="&#x22;_superset_database_name&#x22;" type="&#x22;() -> str&#x22;">
      ...
      <Callout title="&#x22;Example&#x22;" type="&#x22;example&#x22;">
        > > > name = \_superset\_database\_name()
        > > > print(name)
        > > > 'my\_catalog'
      </Callout>

      <Callout title="&#x22;Environment&#x22;" type="&#x22;environment&#x22;">
        SUPERSET\_DATABASE\_NAME: Explicit database display name.
      </Callout>
    ...
    <PyFunction name="&#x22;_query_engine_name&#x22;" type="&#x22;() -> str | None&#x22;">
      Return the configured query\_engine capability name for Superset integration.
      ...
      <Callout title="&#x22;Example&#x22;" type="&#x22;example&#x22;">
        > > > engine = \_query\_engine\_name()
        > > > print(engine)
        > > > 'trino'
      </Callout>

      <Callout title="&#x22;Environment&#x22;" type="&#x22;environment&#x22;">
        SUPERSET\_QUERY\_ENGINE: The target query engine capability name.
      </Callout>
    ...
    <PyFunction name="&#x22;_configured_database_uri&#x22;" type="&#x22;() -> str | None&#x22;">
      ...
      <Callout title="&#x22;Example&#x22;" type="&#x22;example&#x22;">
        > > > uri = \_configured\_database\_uri()
        > > > if uri:
        > > > ...     print(uri)
      ...
      <Callout title="&#x22;Environment&#x22;" type="&#x22;environment&#x22;">
        SUPERSET\_DATABASE\_URI: Direct SQLAlchemy connection URI.
      </Callout>
    ...
    <PyFunction name="&#x22;_discover_query_engine_database_uri&#x22;" type="&#x22;() -> str&#x22;">
      Resolve a SQLAlchemy URI from query\_engine capability metadata.
      ...
      <Callout title="&#x22;Example&#x22;" type="&#x22;example&#x22;">
        > > > uri = \_discover\_query\_engine\_database\_uri()
        > > > print(uri)
        > > > 'trino://user:pass\@localhost:8080/catalog'
      </Callout>

      <Callout title="&#x22;Capability Metadata&#x22;" type="&#x22;capability-metadata&#x22;">
        The query engine capability should provide either:

        * sqlalchemy\_uri: Direct connection URI string.
        * sqlalchemy\_uri\_template: Template with placeholders like \{host}, \{port}.
      </Callout>
    ...
    <PyFunction name="&#x22;add_query_engine_database&#x22;" type="&#x22;() -> None&#x22;">
      ...
      <Callout title="&#x22;Example&#x22;" type="&#x22;example&#x22;">
        ...
        Database connection is now available in Superset [#database-connection-is-now-available-in-superset]
      </Callout>

      <Callout title="&#x22;Environment&#x22;" type="&#x22;environment&#x22;">
        SUPERSET\_URL: Superset base URL (default: [http://localhost:8088](http://localhost:8088)).
        SUPERSET\_ADMIN\_USER: Admin username for API authentication.
        SUPERSET\_ADMIN\_PASSWORD: Admin password for API authentication.
        SUPERSET\_DATABASE\_NAME: Logical name for the database in Superset UI.
        SUPERSET\_DATABASE\_URI: Direct SQLAlchemy URI (optional).
        SUPERSET\_QUERY\_ENGINE: Query engine capability name for auto-discovery.
      </Callout>
