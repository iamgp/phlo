# lineage_import (/docs/python-reference/packages/phlo-dbt/phlo_dbt/lineage_import)
...
> > > from phlo\_dbt.lineage\_import import import\_manifest\_lineage
> > > from pathlib import Path
> > >
> > > summary = import\_manifest\_lineage(Path("target/manifest.json"))
> > > print(f"Imported \{summary\['asset\_edges']} asset edges")
> > > print(f"Imported \{summary\['column\_mappings']} column mappings")
...
<Tabs items="[&#x22;Functions&#x22;]">
  <Tab value="&#x22;Functions&#x22;">
    ...
    <PyFunction name="&#x22;collect_asset_lineage&#x22;" type="&#x22;(manifest, *, translator=None) -> tuple[list[tuple[str, str]], list[str]]&#x22;">
      ...
      <div>
        <PyParameter name="&#x22;manifest&#x22;" type="&#x22;Mapping[str, Any]&#x22;" value="null" />

        <PyParameter name="&#x22;translator&#x22;" type="&#x22;DbtSpecTranslator | None&#x22;" value="&#x22;None&#x22;" />
      </div>

      <PyFunctionReturn type="&#x22;tuple[list[tuple[str, str]], list[str]]&#x22;" />
    </PyFunction>

    <PyFunction name="&#x22;extract_column_lineage&#x22;" type="&#x22;(manifest) -> list[dict[str, Any]]&#x22;">
    ...
    <PyFunction name="&#x22;_resolve_manifest_asset_name&#x22;" type="&#x22;(node) -> str&#x22;">
      ...
      <div>
        <PyParameter name="&#x22;node&#x22;" type="&#x22;Mapping[str, Any]&#x22;" value="null" />
      </div>

      <PyFunctionReturn type="&#x22;str&#x22;" />
    </PyFunction>

    <PyFunction name="&#x22;_get_manifest_columns&#x22;" type="&#x22;(node) -> set[str]&#x22;">
    ...
    <PyFunction name="&#x22;import_manifest_lineage&#x22;" type="&#x22;(manifest_path) -> dict[str, int]&#x22;">
      ...
      * Column-level lineage using same-name heuristics
      ...
      <Callout title="&#x22;Example&#x22;" type="&#x22;example&#x22;">
        ...
        > > >
        > > > summary = import\_manifest\_lineage(Path("target/manifest.json"))
        > > > print(f"Assets: \{summary\['asset\_edges']}")
        > > > print(f"Columns: \{summary\['column\_mappings']}")
        > > >
        > > > Typically called after dbt run [#typically-called-after-dbt-run]
        > > >
        > > > Can be integrated into CI/CD or post-run hooks [#can-be-integrated-into-cicd-or-post-run-hooks]
      </Callout>
      ...
      <div>
        <PyParameter name="&#x22;manifest_path&#x22;" type="&#x22;Path&#x22;" value="undefined">
          Path to the dbt manifest.json file to import.
        </PyParameter>
      </div>
      ...
      <PyFunctionReturn type="&#x22;dict&#x22;">
        ...
        * asset\_edges: Number of asset dependency edges imported
        * column\_mappings: Number of column-level lineage mappings imported
      </PyFunctionReturn>
    </PyFunction>
  </Tab>
</Tabs>
