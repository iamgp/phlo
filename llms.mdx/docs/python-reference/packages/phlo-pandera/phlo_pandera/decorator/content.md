# decorator (/docs/python-reference/packages/phlo-pandera/phlo_pandera/decorator)



@phlo\_pandera decorator for declarative quality checks.
...
<Tabs items="[&#x22;Functions&#x22;]">
  <Tab value="&#x22;Functions&#x22;">
    <PyFunction name="&#x22;phlo_pandera&#x22;" type="&#x22;(table, checks, asset_key=None, group=None, blocking=True, partition_aware=True, warn_threshold=0.0, partition_column='_phlo_partition_date', rolling_window_days=7, full_table=False, description=None, query=None, backend='trino', owner=None, consumers=None, sla=None) -> Callable&#x22;">
      ...
      <div>
        <PyParameter name="&#x22;table&#x22;" type="&#x22;str&#x22;" value="undefined">
          Fully qualified table name (e.g., "bronze.weather\_observations").
        </PyParameter>

        <PyParameter name="&#x22;checks&#x22;" type="&#x22;List[QualityCheck]&#x22;" value="undefined">
          Quality checks to execute.
        </PyParameter>

        <PyParameter name="&#x22;asset_key&#x22;" type="&#x22;Optional[str]&#x22;" value="&#x22;None&#x22;">
          Asset key (derived from table if not provided).
        </PyParameter>

        <PyParameter name="&#x22;group&#x22;" type="&#x22;Optional[str]&#x22;" value="&#x22;None&#x22;">
          Asset group.
        </PyParameter>

        <PyParameter name="&#x22;blocking&#x22;" type="&#x22;bool&#x22;" value="&#x22;True&#x22;">
          Whether failures block downstream assets.
        </PyParameter>

        <PyParameter name="&#x22;partition_aware&#x22;" type="&#x22;bool&#x22;" value="&#x22;True&#x22;">
          Apply partition scoping (default True).
        </PyParameter>

        <PyParameter name="&#x22;warn_threshold&#x22;" type="&#x22;float&#x22;" value="&#x22;0.0&#x22;">
          Max failed-check fraction for WARN vs ERROR.
        </PyParameter>

        <PyParameter name="&#x22;partition_column&#x22;" type="&#x22;str&#x22;" value="&#x22;'_phlo_partition_date'&#x22;">
          Partition column for scoping queries.
        </PyParameter>

        <PyParameter name="&#x22;rolling_window_days&#x22;" type="&#x22;int | None&#x22;" value="&#x22;7&#x22;">
          Scope to last N days when unpartitioned.
        </PyParameter>

        <PyParameter name="&#x22;full_table&#x22;" type="&#x22;bool&#x22;" value="&#x22;False&#x22;">
          Disable partition scoping.
        </PyParameter>
        ...
        <PyParameter name="&#x22;query&#x22;" type="&#x22;Optional[str]&#x22;" value="&#x22;None&#x22;">
          Custom SQL query (defaults to `SELECT * FROM \{table\}`).
        </PyParameter>

        <PyParameter name="&#x22;backend&#x22;" type="&#x22;str&#x22;" value="&#x22;'trino'&#x22;">
          `"trino"` or `"duckdb"`.
        </PyParameter>

        <PyParameter name="&#x22;owner&#x22;" type="&#x22;str | None&#x22;" value="&#x22;None&#x22;">
          Optional quality-check owner/team identifier.
        </PyParameter>

        <PyParameter name="&#x22;consumers&#x22;" type="&#x22;list[Consumer | str] | None&#x22;" value="&#x22;None&#x22;">
          Optional downstream consumer metadata or names.
        </PyParameter>

        <PyParameter name="&#x22;sla&#x22;" type="&#x22;SLA | None&#x22;" value="&#x22;None&#x22;">
          Optional SLA metadata for quality/freshness alerting.
        </PyParameter>
      </div>
    ...
    <PyFunction name="&#x22;get_quality_checks&#x22;" type="&#x22;() -> list[AssetCheckSpec]&#x22;">
      Get all asset check specs registered with @phlo\_pandera decorator.
    ...
    <PyFunction name="&#x22;clear_quality_checks&#x22;" type="&#x22;() -> None&#x22;">
