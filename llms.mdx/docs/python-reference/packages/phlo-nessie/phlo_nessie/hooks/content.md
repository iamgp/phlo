# hooks (/docs/python-reference/packages/phlo-nessie/phlo_nessie/hooks)
...
<Tabs items="[&#x22;Functions&#x22;]">
  <Tab value="&#x22;Functions&#x22;">
    <PyFunction name="&#x22;_get_json&#x22;" type="&#x22;(url) -> dict[str, Any]&#x22;">
      ...
      <Callout title="&#x22;Example&#x22;" type="&#x22;example&#x22;">
        > > > data = \_get\_json("[http://localhost:19120/api/v1/trees](http://localhost:19120/api/v1/trees)")
    ...
    <PyFunction name="&#x22;_post_json&#x22;" type="&#x22;(url, payload) -> dict[str, Any]&#x22;">
      ...
      <Callout title="&#x22;Example&#x22;" type="&#x22;example&#x22;">
        > > > result = \_post\_json(
        > > > ...     "[http://localhost:19120/api/v1/trees/tree](http://localhost:19120/api/v1/trees/tree)",
    ...
    <PyFunction name="&#x22;_delete&#x22;" type="&#x22;(url) -> int&#x22;">
      Perform a DELETE request and return the HTTP status code.

      <Callout title="&#x22;Example&#x22;" type="&#x22;example&#x22;">
        > > > status = \_delete("[http://localhost:19120/api/v1/trees/branch/old](http://localhost:19120/api/v1/trees/branch/old)")
        > > > print(status)
        > > > 204
      </Callout>
    ...
    <PyFunction name="&#x22;_resolve_nessie_url&#x22;" type="&#x22;() -> str&#x22;">
      Resolve the Nessie base URL from environment variables.

      Checks NESSIE\_URL first, then falls back to localhost with
      NESSIE\_PORT (defaulting to 19120).

      <Callout title="&#x22;Example&#x22;" type="&#x22;example&#x22;">
        > > > url = \_resolve\_nessie\_url()
        > > > '[http://localhost:19120](http://localhost:19120)'
      </Callout>
      ...
      <PyFunctionReturn type="&#x22;str&#x22;">
        Nessie base URL without trailing slash.
      </PyFunctionReturn>
    </PyFunction>

    <PyFunction name="&#x22;_get_ref_log&#x22;" type="&#x22;(base_url, ref) -> list[dict[str, Any]]&#x22;">
      Return the Nessie commit log entries for a ref.

      Retrieves the most recent commit log entry for a given reference.

      <Callout title="&#x22;Example&#x22;" type="&#x22;example&#x22;">
        > > > log = \_get\_ref\_log("[http://localhost:19120](http://localhost:19120)", "main")
    ...
    <PyFunction name="&#x22;_get_iceberg_prefix&#x22;" type="&#x22;(base_url, ref) -> str&#x22;">
      ...
      <Callout title="&#x22;Example&#x22;" type="&#x22;example&#x22;">
        > > > prefix = \_get\_iceberg\_prefix("[http://localhost:19120](http://localhost:19120)", "main")
        > > > 'main'
      </Callout>
      ...
      <PyFunctionReturn type="&#x22;str&#x22;">
        Iceberg REST prefix string.
      </PyFunctionReturn>
    </PyFunction>

    <PyFunction name="&#x22;_delete_namespace_if_present&#x22;" type="&#x22;(base_url, prefix, namespace) -> None&#x22;">
      ...
      <Callout title="&#x22;Example&#x22;" type="&#x22;example&#x22;">
        > > > \_delete\_namespace\_if\_present(
        > > > ...     "[http://localhost:19120](http://localhost:19120)", "main", "**phlo\_bootstrap\_main**"
        > > > ... )
      </Callout>
      ...
      <div>
        ...
        <PyParameter name="&#x22;prefix&#x22;" type="&#x22;str&#x22;" value="undefined">
          Iceberg REST prefix for the reference.
        </PyParameter>
    ...
    <PyFunction name="&#x22;_ensure_bootstrap_commit&#x22;" type="&#x22;(base_url, ref) -> None&#x22;">
      ...
      <Callout title="&#x22;Example&#x22;" type="&#x22;example&#x22;">
        > > > \_ensure\_bootstrap\_commit("[http://localhost:19120](http://localhost:19120)", "main")
      </Callout>
    ...
    <PyFunction name="&#x22;init_branches&#x22;" type="&#x22;() -> int&#x22;">
    ...
    <PyFunction name="&#x22;main&#x22;" type="&#x22;() -> int&#x22;">
      ...
      <Callout title="&#x22;Example&#x22;" type="&#x22;example&#x22;">
        $ python -m phlo\_nessie.hooks init-branches
      </Callout>

      <Callout title="&#x22;Commands&#x22;" type="&#x22;commands&#x22;">
