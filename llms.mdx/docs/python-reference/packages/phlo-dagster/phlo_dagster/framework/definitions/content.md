# definitions (/docs/python-reference/packages/phlo-dagster/phlo_dagster/framework/definitions)
...
* Extensions: Discovered via phlo.plugins.dagster entry\_points
...
1. PHLO\_FORCE\_IN\_PROCESS\_EXECUTOR (override)
2. PHLO\_FORCE\_MULTIPROCESS\_EXECUTOR (override)
...
* build\_definitions(): Programmatic entry point
...
from phlo\_dagster.framework.definitions import build\_definitions

defs = build\_definitions()
...
<PyAttribute name="&#x22;defs&#x22;" type="null" value="&#x22;build_definitions()&#x22;" />

<Tabs items="[&#x22;Functions&#x22;]">
  <Tab value="&#x22;Functions&#x22;">
    <PyFunction name="&#x22;_collect_wap_definitions&#x22;" type="&#x22;() -> dg.Definitions | None&#x22;">
      ...
      <PyFunctionReturn type="&#x22;dg.Definitions | None&#x22;">
        Dagster Definitions containing WAP sensors, or None if WAP is not available.
      </PyFunctionReturn>
    </PyFunction>

    <PyFunction name="&#x22;_default_executor&#x22;" type="&#x22;() -> dg.ExecutorDefinition | None&#x22;">
      Choose an executor suited to the current environment.

      Priority order:

      1. PHLO\_FORCE\_IN\_PROCESS\_EXECUTOR (explicit override)
      2. PHLO\_FORCE\_MULTIPROCESS\_EXECUTOR (explicit override)
      3. PHLO\_HOST\_PLATFORM (from environment, for Docker on macOS)
      ...
      <PyFunctionReturn type="&#x22;dg.ExecutorDefinition | None&#x22;">
        Executor definition or None to use default
      </PyFunctionReturn>
    </PyFunction>

    <PyFunction name="&#x22;build_definitions&#x22;" type="&#x22;(workflows_path=None) -> Any&#x22;">
      ...
      2. Discovers user workflows from workflows\_path
      ...
      <div>
        <PyParameter name="&#x22;workflows_path&#x22;" type="&#x22;Path | str | None&#x22;" value="&#x22;None&#x22;">
          Path to user workflows directory. If None, uses
          configuration value (default: "workflows")
        </PyParameter>
      </div>
