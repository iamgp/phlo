# decorator (/docs/python-reference/packages/phlo-dlt/phlo_dlt/decorator)
...
* :func:`_validate_unique_key_in_schema`: Validate unique\_key exists in schema
...
<Tabs items="[&#x22;Functions&#x22;]">
  <Tab value="&#x22;Functions&#x22;">
    <PyFunction name="&#x22;get_ingestion_assets&#x22;" type="&#x22;() -> list[AssetSpec]&#x22;">
    ...
    <PyFunction name="&#x22;clear_ingestion_assets&#x22;" type="&#x22;() -> None&#x22;">
    ...
    <PyFunction name="&#x22;_validate_unique_key_in_schema&#x22;" type="&#x22;(unique_key, schema) -> None&#x22;">
      ...
      <div>
        <PyParameter name="&#x22;unique_key&#x22;" type="&#x22;str&#x22;" value="undefined">
          Column name used to identify unique records.
        </PyParameter>

        <PyParameter name="&#x22;schema&#x22;" type="&#x22;type[Any] | None&#x22;" value="undefined">
          Optional schema class used for validation.
        </PyParameter>
      </div>
    ...
    <PyFunction name="&#x22;_validate_merge_config&#x22;" type="&#x22;(merge_strategy, unique_key, merge_config) -> None&#x22;">
      ...
      <div>
        <PyParameter name="&#x22;merge_strategy&#x22;" type="&#x22;str&#x22;" value="undefined">
          Write strategy for ingestion (`append` or `merge`).
        </PyParameter>

        <PyParameter name="&#x22;unique_key&#x22;" type="&#x22;str&#x22;" value="undefined">
          Column name used for deduplication and merge operations.
        </PyParameter>

        <PyParameter name="&#x22;merge_config&#x22;" type="&#x22;dict[str, Any] | None&#x22;" value="undefined">
          Optional merge behavior overrides.
        </PyParameter>
      </div>
    ...
    <PyFunction name="&#x22;_default_merge_config&#x22;" type="&#x22;(merge_strategy, merge_config) -> dict[str, Any]&#x22;">
      ...
      <div>
        ...
        <PyParameter name="&#x22;merge_config&#x22;" type="&#x22;dict[str, Any] | None&#x22;" value="undefined">
          Optional user-provided merge configuration.
        </PyParameter>
      </div>
    ...
    <PyFunction name="&#x22;_resolve_table_store_capability&#x22;" type="&#x22;(context) -> tuple[Any, str]&#x22;">
      ...
      <Callout title="&#x22;Resolution Order&#x22;" type="&#x22;resolution-order&#x22;">
        ...
        2. Check PHLO\_DEFAULT\_CAPABILITIES environment variable
      ...
      <div>
        <PyParameter name="&#x22;context&#x22;" type="&#x22;RuntimeContext&#x22;" value="undefined">
          Runtime context with capability configuration.
        </PyParameter>
      </div>

      <PyFunctionReturn type="&#x22;tuple&#x22;">
        tuple\[Any, str]: Tuple of (provider\_instance, provider\_name).
      </PyFunctionReturn>
    </PyFunction>

    <PyFunction name="&#x22;phlo_ingestion&#x22;" type="&#x22;(table_name, unique_key, group, validation_schema=None, table_schema=None, partition_spec=None, cron=None, freshness_hours=None, max_runtime_seconds=300, max_retries=3, retry_delay_seconds=30, validate=True, strict_validation=True, merge_strategy='merge', merge_config=None, add_metadata_columns=True, owner=None, consumers=None, sla=None, capabilities=None) -> Callable[[Callable[..., Any]], Callable[..., Any]]&#x22;">
      ...
      <Callout title="&#x22;Asset Naming&#x22;" type="&#x22;asset-naming&#x22;">
        The generated asset key is `dlt_\{table_name\}`. For example, a table
        named "users" becomes asset key "dlt\_users".
      </Callout>

      <Callout title="&#x22;Execution Flow&#x22;" type="&#x22;execution-flow&#x22;">
        1. Call the decorated function to get DLT source/data
        2. Stage data to Parquet via DLT
        3. Inject metadata columns (\_phlo\_row\_id, \_phlo\_ingested\_at, etc.)
      ...
      <Callout title="&#x22;Validation Modes&#x22;" type="&#x22;validation-modes&#x22;">
      ...
      <div>
        <PyParameter name="&#x22;table_name&#x22;" type="&#x22;str&#x22;" value="undefined">
          Destination table-store table name (without `dlt_` prefix).
          This is used for both the asset key and the physical table name.
        </PyParameter>

        <PyParameter name="&#x22;unique_key&#x22;" type="&#x22;str&#x22;" value="undefined">
          Column used for deduplication and merge operations.
          Must exist in the validation\_schema if one is provided.
        </PyParameter>

        <PyParameter name="&#x22;group&#x22;" type="&#x22;str&#x22;" value="undefined">
          Dagster/asset group name for organizing related assets.
        </PyParameter>

        <PyParameter name="&#x22;validation_schema&#x22;" type="&#x22;type[Any] | None&#x22;" value="&#x22;None&#x22;">
          Optional Pandera DataFrameModel for data contract checks.
          If provided, data will be validated against this schema.
        </PyParameter>

        <PyParameter name="&#x22;table_schema&#x22;" type="&#x22;Any | None&#x22;" value="&#x22;None&#x22;">
          Optional explicit table-store schema. If not provided,
          the table\_store provider will derive schema from validation\_schema.
        </PyParameter>

        <PyParameter name="&#x22;partition_spec&#x22;" type="&#x22;Any | None&#x22;" value="&#x22;None&#x22;">
          Optional partition specification for the table store.
          Format depends on the table store provider (e.g., Iceberg transforms).
        </PyParameter>

        <PyParameter name="&#x22;cron&#x22;" type="&#x22;str | None&#x22;" value="&#x22;None&#x22;">
          Optional cron schedule for automated runs (e.g., "0 \*/6 \* \* \*" for every 6 hours).
        </PyParameter>

        <PyParameter name="&#x22;freshness_hours&#x22;" type="&#x22;tuple[int, int] | None&#x22;" value="&#x22;None&#x22;">
          Optional freshness policy as (warning\_hours, error\_hours) tuple.
          Used for SLA monitoring and alerting.
        </PyParameter>

        <PyParameter name="&#x22;max_runtime_seconds&#x22;" type="&#x22;int&#x22;" value="&#x22;300&#x22;">
          Maximum runtime before timeout (default: 300 seconds).
        </PyParameter>
        ...
        <PyParameter name="&#x22;validate&#x22;" type="&#x22;bool&#x22;" value="&#x22;True&#x22;">
          Whether to execute Pandera contract checks (default: True).
        </PyParameter>

        <PyParameter name="&#x22;strict_validation&#x22;" type="&#x22;bool&#x22;" value="&#x22;True&#x22;">
          Whether failed validation should fail the run (default: True).
          When True, enables Write-Audit-Publish pattern with isolated branches.
        </PyParameter>

        <PyParameter name="&#x22;merge_strategy&#x22;" type="&#x22;Literal['append', 'merge']&#x22;" value="&#x22;'merge'&#x22;">
          Ingestion write strategy:

          * `"append"`: Insert-only, never update existing rows
          * `"merge"`: Upsert based on unique\_key (default)
        </PyParameter>

        <PyParameter name="&#x22;merge_config&#x22;" type="&#x22;dict[str, Any] | None&#x22;" value="&#x22;None&#x22;">
          Optional merge behavior overrides as a dict.
          Common options: `\{"deduplication": True, "deduplication_method": "last"\}`
        </PyParameter>

        <PyParameter name="&#x22;add_metadata_columns&#x22;" type="&#x22;bool&#x22;" value="&#x22;True&#x22;">
          Whether to inject Phlo metadata columns (default: True).
          Columns added: \_phlo\_row\_id, \_phlo\_ingested\_at, \_phlo\_partition\_date, \_phlo\_run\_id
        </PyParameter>

        <PyParameter name="&#x22;owner&#x22;" type="&#x22;str | None&#x22;" value="&#x22;None&#x22;">
          Optional asset owner/team identifier for governance.
        </PyParameter>

        <PyParameter name="&#x22;consumers&#x22;" type="&#x22;list[Consumer | str] | None&#x22;" value="&#x22;None&#x22;">
          Optional list of downstream consumers (strings or Consumer objects)
          for lineage and impact analysis.
        </PyParameter>

        <PyParameter name="&#x22;sla&#x22;" type="&#x22;SLA | None&#x22;" value="&#x22;None&#x22;">
          Optional SLA metadata for freshness/quality alerting.
        </PyParameter>

        <PyParameter name="&#x22;capabilities&#x22;" type="&#x22;dict[str, str] | None&#x22;" value="&#x22;None&#x22;">
          Optional capability provider overrides for this asset.
          Format: `\{"table_store": "iceberg", "catalog": "nessie"\}`
        </PyParameter>
      </div>
