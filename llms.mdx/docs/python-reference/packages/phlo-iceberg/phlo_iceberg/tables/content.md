# tables (/docs/python-reference/packages/phlo-iceberg/phlo_iceberg/tables)
...
from phlo\_iceberg.tables import ensure\_table, append\_to\_table, merge\_to\_table
from pyiceberg.schema import Schema
from pyiceberg.types import NestedField, StringType, LongType

Create or get existing table [#create-or-get-existing-table]

schema = Schema(
NestedField(1, "id", LongType(), required=True),
NestedField(2, "name", StringType(), required=False),
)
table = ensure\_table("raw\.users", schema=schema)

Append data [#append-data]

result = append\_to\_table("raw\.users", data\_path="/data/users.parquet")
print(f"Inserted \{result\['rows\_inserted']} rows")

Merge (upsert) data by unique key [#merge-upsert-data-by-unique-key]

result = merge\_to\_table(
"raw\.users",
data\_path="/data/updates.parquet",
unique\_key="id"
)
print(f"Updated \{result\['rows\_deleted']} rows, inserted \{result\['rows\_inserted']} rows")
...
<Tabs items="[&#x22;Functions&#x22;]">
  <Tab value="&#x22;Functions&#x22;">
    <PyFunction name="&#x22;_align_arrow_table_to_target_schema&#x22;" type="&#x22;(arrow_table, target_schema, *, table_name)&#x22;">
      ...
      <Callout title="&#x22;Example&#x22;" type="&#x22;example&#x22;">
        ...
        aligned = \_align\_arrow\_table\_to\_target\_schema(
        arrow\_table, target\_schema, table\_name="raw\.users"
        )
      </Callout>
      ...
      <div>
        <PyParameter name="&#x22;arrow_table&#x22;" type="null" value="undefined">
          PyArrow Table to align.
        </PyParameter>

        <PyParameter name="&#x22;target_schema&#x22;" type="null" value="undefined">
          Target Iceberg schema as PyArrow schema.
        </PyParameter>

        <PyParameter name="&#x22;table_name&#x22;" type="&#x22;str&#x22;" value="undefined">
          Name of the target table for error messages.
        </PyParameter>
      </div>
    ...
    <PyFunction name="&#x22;ensure_table&#x22;" type="&#x22;(table_name, schema, partition_spec=None, ref='main') -> Table&#x22;">
      ...
      <Callout title="&#x22;Example&#x22;" type="&#x22;example&#x22;">
        ...
        schema = Schema(
        NestedField(1, "id", LongType(), required=True),
        NestedField(2, "event\_time", TimestamptzType(), required=True),
        ...
        "raw\.events",
        schema=schema,
        partition\_spec=\[("event\_time", "day")],
        ref="main"
        )
      </Callout>
      ...
      <div>
        <PyParameter name="&#x22;table_name&#x22;" type="&#x22;str&#x22;" value="undefined">
          Fully qualified table name in `namespace.table` format.
        </PyParameter>

        <PyParameter name="&#x22;schema&#x22;" type="&#x22;Schema&#x22;" value="undefined">
          Iceberg schema defining table structure.
        </PyParameter>

        <PyParameter name="&#x22;partition_spec&#x22;" type="&#x22;list[tuple[str, str]] | None&#x22;" value="&#x22;None&#x22;">
          Optional partitioning specification as list of
          `(column_name, transform)` tuples. Supported transforms:
          `identity`, `day`, `hour`, `month`, `year`.
        </PyParameter>

        <PyParameter name="&#x22;ref&#x22;" type="&#x22;str&#x22;" value="&#x22;'main'&#x22;">
          Nessie branch/tag reference (default: `main`).
        </PyParameter>
      </div>
    ...
    <PyFunction name="&#x22;append_to_table&#x22;" type="&#x22;(table_name, data_path, ref='main') -> dict[str, int]&#x22;">
      ...
      <Callout title="&#x22;Example&#x22;" type="&#x22;example&#x22;">
        ...
        result = append\_to\_table(
        table\_name="raw\.events",
        data\_path="/data/events\_2024-01-01.parquet"
        )
        print(f"Appended \{result\['rows\_inserted']} rows")

        Append directory of Parquet files::

        result = append\_to\_table(
        table\_name="raw\.events",
        data\_path="/data/daily\_batches/",
        ref="main"
        )
      </Callout>
      ...
      <div>
        ...
        <PyParameter name="&#x22;data_path&#x22;" type="&#x22;str | Path&#x22;" value="undefined">
          Path to Parquet file or directory containing data files.
        </PyParameter>
      ...
      <PyFunctionReturn type="&#x22;dict&#x22;">
        Operation statistics containing:
    ...
    <PyFunction name="&#x22;merge_to_table&#x22;" type="&#x22;(table_name, data_path, unique_key, ref='main') -> dict[str, int]&#x22;">
      ...
      <Callout title="&#x22;The merge operation&#x22;" type="&#x22;the-merge-operation&#x22;">
      ...
      <Callout title="&#x22;Example&#x22;" type="&#x22;example&#x22;">
        ...
        print(f"Deleted \~\{result\['rows\_deleted']} existing rows")
        print(f"Inserted \{result\['rows\_inserted']} new rows")
      </Callout>
      ...
      <div>
        ...
        <PyParameter name="&#x22;unique_key&#x22;" type="&#x22;str&#x22;" value="undefined">
          Column name used to identify matching rows for deletion.
        </PyParameter>
    ...
    <PyFunction name="&#x22;overwrite_table&#x22;" type="&#x22;(table_name, data_path, ref='main') -> dict[str, int]&#x22;">
      ...
      <Callout title="&#x22;Example&#x22;" type="&#x22;example&#x22;">
        ...
        result = overwrite\_table(
        table\_name="raw\.daily\_summary",
        data\_path="/data/regenerated\_summary.parquet"
        )
        print(f"Table now contains \{result\['rows\_inserted']} rows")
      </Callout>
      ...
      <div>
        ...
        <PyParameter name="&#x22;data_path&#x22;" type="&#x22;str | Path&#x22;" value="undefined">
          Path to Parquet file or directory containing replacement data.
        </PyParameter>
    ...
    <PyFunction name="&#x22;delete_rows_from_table&#x22;" type="&#x22;(table_name, predicate, ref='main') -> dict[str, int]&#x22;">
      ...
      <Callout title="&#x22;Example&#x22;" type="&#x22;example&#x22;">
        ...
        table\_name="raw\.events",
        predicate="event\_time \< '2024-01-01T00:00:00Z'"
        )

        Delete by status::

        delete\_rows\_from\_table(
        table\_name="raw\.users",
    ...
    <PyFunction name="&#x22;list_table_snapshots&#x22;" type="&#x22;(table_name, limit=10, ref='main') -> list[dict]&#x22;">
      ...
      <PyFunctionReturn type="&#x22;list&#x22;">
        List of snapshot dicts (most recent first), each with snapshot\_id,
      </PyFunctionReturn>
    </PyFunction>

    <PyFunction name="&#x22;rollback_table_to_snapshot&#x22;" type="&#x22;(table_name, snapshot_id, ref='main') -> dict&#x22;">
      ...
      <div>
        ...
        <PyParameter name="&#x22;snapshot_id&#x22;" type="&#x22;int&#x22;" value="undefined">
          Target snapshot ID.
        </PyParameter>
      ...
      <PyFunctionReturn type="&#x22;dict&#x22;">
        Dict with rolled\_back\_to snapshot ID.
      </PyFunctionReturn>
    </PyFunction>

    <PyFunction name="&#x22;get_table_schema&#x22;" type="&#x22;(table_name, ref='main') -> Schema&#x22;">
      Get the current schema of an Iceberg table.

      <Callout title="&#x22;Example&#x22;" type="&#x22;example&#x22;">
        Inspect table structure::

        schema = get\_table\_schema("raw\.events")
        for field in schema.fields:
        print(f"\{field.name}: \{field.field\_type}")
      </Callout>
      ...
      <PyFunctionReturn type="&#x22;pyiceberg.schema.Schema&#x22;">
        The Iceberg schema object for the table.
      </PyFunctionReturn>
    </PyFunction>

    <PyFunction name="&#x22;delete_table&#x22;" type="&#x22;(table_name, ref='main') -> None&#x22;">
      ...
      <Callout title="&#x22;Example&#x22;" type="&#x22;example&#x22;">
        ...
        delete\_table("raw\.temp\_data", ref="main")
    ...
    <PyFunction name="&#x22;expire_snapshots&#x22;" type="&#x22;(table_name, older_than_days=None, retain_last=5, ref='main', *, older_than_hours=None) -> dict[str, int]&#x22;">
      ...
      <div>
        ...
        <PyParameter name="&#x22;older_than_days&#x22;" type="&#x22;int | None&#x22;" value="&#x22;None&#x22;">
          Expire snapshots older than this many days (must be positive).
          Mutually exclusive with `older_than_hours`; defaults to 7 when neither is set.
        </PyParameter>

        <PyParameter name="&#x22;retain_last&#x22;" type="&#x22;int&#x22;" value="&#x22;5&#x22;">
        ...
        <PyParameter name="&#x22;older_than_hours&#x22;" type="&#x22;int | None&#x22;" value="&#x22;None&#x22;">
          Expire snapshots older than this many hours (must be positive).
        </PyParameter>
      </div>

      <PyFunctionReturn type="&#x22;dict&#x22;">
        Dict with deleted\_snapshots count
      </PyFunctionReturn>
    </PyFunction>

    <PyFunction name="&#x22;remove_orphan_files&#x22;" type="&#x22;(table_name, older_than_days=None, dry_run=True, ref='main', *, older_than_hours=None) -> dict[str, int | list[str] | bool]&#x22;">
      Remove orphan files not referenced by any snapshot.

      WARNING: When dry\_run=False, this operation permanently deletes files from storage.
      There is a race condition risk if new snapshots are being written concurrently.
      Always test with dry\_run=True first and ensure no concurrent writes during cleanup.
      ...
      <div>
        ...
        <PyParameter name="&#x22;older_than_days&#x22;" type="&#x22;int | None&#x22;" value="&#x22;None&#x22;">
          Only remove files older than this many days (must be positive).
          Mutually exclusive with `older_than_hours`; defaults to 3 when neither is set.
        </PyParameter>

        <PyParameter name="&#x22;dry_run&#x22;" type="&#x22;bool&#x22;" value="&#x22;True&#x22;">
          If True, only list files without deleting
        </PyParameter>
        ...
        <PyParameter name="&#x22;older_than_hours&#x22;" type="&#x22;int | None&#x22;" value="&#x22;None&#x22;">
          Only remove files older than this many hours (must be positive).
        </PyParameter>
      </div>

      <PyFunctionReturn type="&#x22;dict&#x22;">
        Dict with orphan\_count, orphan\_files list, and dry\_run flag
      </PyFunctionReturn>
    </PyFunction>

    <PyFunction name="&#x22;get_table_stats&#x22;" type="&#x22;(table_name, ref='main') -> dict&#x22;">
      ...
      <PyFunctionReturn type="&#x22;dict&#x22;">
        Dict with snapshot\_count, file\_count, total\_size\_bytes, etc.
      </PyFunctionReturn>
    </PyFunction>
  </Tab>
</Tabs>
