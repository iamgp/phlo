# catalog (/docs/python-reference/packages/phlo-iceberg/phlo_iceberg/catalog)
...
from phlo\_iceberg.catalog import get\_catalog, list\_tables, create\_namespace

Get catalog connection [#get-catalog-connection]

catalog = get\_catalog(ref="main")

List tables in namespace [#list-tables-in-namespace]

tables = list\_tables(namespace="raw", ref="main")
print(f"Tables in raw namespace: \{tables}")

Create namespace [#create-namespace]

create\_namespace("staging", ref="main")

See Also:

* Nessie Catalog: [https://projectnessie.org/](https://projectnessie.org/)
* Iceberg REST Catalog: [https://iceberg.apache.org/docs/latest/configuration/](https://iceberg.apache.org/docs/latest/configuration/)

<PyAttribute name="&#x22;logger&#x22;" type="null" value="&#x22;get_logger(__name__)&#x22;" />

<Tabs items="[&#x22;Functions&#x22;]">
  <Tab value="&#x22;Functions&#x22;">
    <PyFunction name="&#x22;get_catalog&#x22;" type="&#x22;(ref='main')&#x22;">
      ...
      <Callout title="&#x22;Example&#x22;" type="&#x22;example&#x22;">
        ...
        main\_catalog = get\_catalog(ref="main")
        dev\_catalog = get\_catalog(ref="dev-branch")

        Access tables through catalog [#access-tables-through-catalog]

        table = main\_catalog.load\_table("raw\.events")
      </Callout>
    ...
    <PyFunction name="&#x22;reset_catalog_cache&#x22;" type="&#x22;() -> None&#x22;">
      ...
      reset\_catalog\_cache()
      catalog = get\_catalog(ref="main")  # Fresh connection
    ...
    <PyFunction name="&#x22;list_tables&#x22;" type="&#x22;(namespace=None, ref='main') -> list[str]&#x22;">
      ...
      <Callout title="&#x22;Example&#x22;" type="&#x22;example&#x22;">
        ...
        all\_tables = list\_tables(namespace=None, ref="main")
        print(f"Total tables: \{len(all\_tables)}")
      </Callout>
      ...
      <div>
        <PyParameter name="&#x22;namespace&#x22;" type="&#x22;str | None&#x22;" value="&#x22;None&#x22;">
          Namespace name to filter by. If None, lists tables
          across all namespaces.
        </PyParameter>
    ...
    <PyFunction name="&#x22;create_namespace&#x22;" type="&#x22;(namespace, ref='main') -> None&#x22;">
      ...
      <Callout title="&#x22;Example&#x22;" type="&#x22;example&#x22;">
        ...
        create\_namespace("staging", ref="main")
        create\_namespace("staging\_temp", ref="dev")
      </Callout>
      ...
      <PyFunctionReturn type="&#x22;None&#x22;">
        Always returns None. Errors are logged but not raised for
        existing namespaces.
      </PyFunctionReturn>
    </PyFunction>
  </Tab>
