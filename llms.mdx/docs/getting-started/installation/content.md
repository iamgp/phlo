...
Step 1: Install Phlo [#step-1-install-phlo]
...
Step 6: Create and Run Your First Pipeline [#step-6-create-and-run-your-first-pipeline]
...
You can also use the Dagster UI at [http://localhost:10006](http://localhost:10006) to materialize assets.
...
With Optional Services [#with-optional-services]
...
Native Services Mode [#native-services-mode]
...
Open [http://localhost:10001](http://localhost:10001) in browser
