# 10-Minute Quickstart (/docs/getting-started/quickstart)
...
Step 1: Clone and Setup (2 minutes) [#step-1-clone-and-setup-2-minutes]
...
Step 2: View Dagster UI (30 seconds) [#step-2-view-dagster-ui-30-seconds]
...
Step 3: Understand the Asset (2 minutes) [#step-3-understand-the-asset-2-minutes]
...
Step 4: Materialize the Asset (1 minute) [#step-4-materialize-the-asset-1-minute]
...
Step 5: Query Your Data (2 minutes) [#step-5-query-your-data-2-minutes]

Option A: Trino (SQL) [#option-a-trino-sql]
...
Option B: DuckDB (local analysis) [#option-b-duckdb-local-analysis]
...
Create Your Own Ingestion Asset (15 minutes) [#create-your-own-ingestion-asset-15-minutes]
...
Build Complete Pipeline (60 minutes) [#build-complete-pipeline-60-minutes]
