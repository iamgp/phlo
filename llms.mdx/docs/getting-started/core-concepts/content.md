...
1\. Write-Audit-Publish (WAP) Pattern [#1-write-audit-publish-wap-pattern]
...
2\. Decorator-Driven Development [#2-decorator-driven-development]
...
@phlo_quality Decorator [#phlo_quality-decorator]
...
3\. Schema-First Development [#3-schema-first-development]
...
Manual Schema Definition [#manual-schema-definition]
...
Schema Generation from dbt YAML [#schema-generation-from-dbt-yaml]
...
6\. Bronze/Silver/Gold Architecture [#6-bronzesilvergold-architecture]
...
7\. Branch-Aware Operations [#7-branch-aware-operations]
...
8\. Asset-Based Orchestration [#8-asset-based-orchestration]
...
10\. Publishing Pattern [#10-publishing-pattern]
