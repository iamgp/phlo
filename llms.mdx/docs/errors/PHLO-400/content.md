# PHLO-400: Iceberg Catalog Error (/docs/errors/PHLO-400)
...
Solution 1: Start catalog services [#solution-1-start-catalog-services]
...
Solution 2: Verify catalog configuration [#solution-2-verify-catalog-configuration]
...
Solution 3: Test catalog connection [#solution-3-test-catalog-connection]
...
Solution 4: Create missing namespace [#solution-4-create-missing-namespace]
...
Incorrect: No catalog error handling [#incorrect-no-catalog-error-handling]
...
Correct: Handle catalog errors [#correct-handle-catalog-errors]
