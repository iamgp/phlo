# Phlo Error Documentation (/docs/errors/README)
...
Discovery and Configuration Errors (PHLO-001 to PHLO-099) [#discovery-and-configuration-errors-phlo-001-to-phlo-099]

Errors related to asset discovery, configuration, and setup.

PHLO-001: Asset Not Discovered [#phlo-001-asset-not-discovered]
...
PHLO-002: Schema Mismatch [#phlo-002-schema-mismatch]
...
PHLO-003: Invalid Cron Expression [#phlo-003-invalid-cron-expression]
...
PHLO-004: Validation Failed [#phlo-004-validation-failed]
...
PHLO-005: Missing Schema [#phlo-005-missing-schema]
...
* validation\_schema parameter missing
...
Runtime and Integration Errors (PHLO-006 to PHLO-099) [#runtime-and-integration-errors-phlo-006-to-phlo-099]

Errors during asset execution and external integrations.

PHLO-006: Ingestion Failed [#phlo-006-ingestion-failed]
...
PHLO-007: Table Not Found [#phlo-007-table-not-found]
...
PHLO-008: Infrastructure Error [#phlo-008-infrastructure-error]
...
Schema and Type Errors (PHLO-200 to PHLO-299) [#schema-and-type-errors-phlo-200-to-phlo-299]

Errors related to schema conversion and type handling.

PHLO-200: Schema Conversion Error [#phlo-200-schema-conversion-error]
...
PHLO-201: Type Conversion Error [#phlo-201-type-conversion-error]
...
DLT Errors (PHLO-300 to PHLO-399) [#dlt-errors-phlo-300-to-phlo-399]

Errors specific to DLT (Data Load Tool) operations.

PHLO-300: DLT Pipeline Failed [#phlo-300-dlt-pipeline-failed]
...
PHLO-301: DLT Source Error [#phlo-301-dlt-source-error]
...
Iceberg Errors (PHLO-400 to PHLO-499) [#iceberg-errors-phlo-400-to-phlo-499]

Errors related to Apache Iceberg operations.

PHLO-400: Iceberg Catalog Error [#phlo-400-iceberg-catalog-error]
...
PHLO-401: Iceberg Table Error [#phlo-401-iceberg-table-error]
...
PHLO-402: Iceberg Write Error [#phlo-402-iceberg-write-error]
...
1\. Use Structured Error Classes [#1-use-structured-error-classes]
...
2\. Provide Actionable Suggestions [#2-provide-actionable-suggestions]
...
3\. Include Context [#3-include-context]
...
4\. Log Errors Appropriately [#4-log-errors-appropriately]
...
5\. Test Error Paths [#5-test-error-paths]
