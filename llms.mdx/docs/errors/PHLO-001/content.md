# PHLO-001: Asset Not Discovered (/docs/errors/PHLO-001)
...
Solution 1: Verify workflow placement [#solution-1-verify-workflow-placement]
...
Solution 2: Ensure Dagster loads phlo_dagster.framework.definitions [#solution-2-ensure-dagster-loads-phlo_dagsterframeworkdefinitions]
...
Solution 3: Check for import errors [#solution-3-check-for-import-errors]
...
Solution 4: Verify decorator usage [#solution-4-verify-decorator-usage]
...
Incorrect: Asset outside workflows path [#incorrect-asset-outside-workflows-path]

```
custom_assets/observations.py  # Not under workflows/
```

Correct: Asset under workflows path [#correct-asset-under-workflows-path]

```
workflows/ingestion/weather/observations.py
```

Incorrect: Missing decorator [#incorrect-missing-decorator]
...
Correct: Decorator applied [#correct-decorator-applied]
