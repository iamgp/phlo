# PHLO-301: DLT Source Error (/docs/errors/PHLO-301)
...
Solution 1: Verify source accessibility [#solution-1-verify-source-accessibility]
...
Solution 2: Check and refresh credentials [#solution-2-check-and-refresh-credentials]
...
Solution 3: Handle rate limiting [#solution-3-handle-rate-limiting]
...
Solution 4: Validate response format [#solution-4-validate-response-format]
...
Incorrect: No source validation [#incorrect-no-source-validation]
...
Correct: Source with validation and error handling [#correct-source-with-validation-and-error-handling]
