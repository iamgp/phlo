# PHLO-200: Schema Conversion Error (/docs/errors/PHLO-200)
...
Solution 1: Use supported types [#solution-1-use-supported-types]
...
Solution 2: Simplify complex types [#solution-2-simplify-complex-types]
...
Solution 3: Override type mapping [#solution-3-override-type-mapping]
...
Incorrect: Unsupported type [#incorrect-unsupported-type]
...
Correct: Supported types only [#correct-supported-types-only]
