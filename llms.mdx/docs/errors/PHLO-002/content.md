# PHLO-002: Schema Mismatch (/docs/errors/PHLO-002)
...
Solution 1: Verify unique_key exists in schema [#solution-1-verify-unique_key-exists-in-schema]
...
Solution 2: Fix typos with fuzzy matching [#solution-2-fix-typos-with-fuzzy-matching]
...
Solution 3: Use schema inspection [#solution-3-use-schema-inspection]
...
Solution 4: Check field case sensitivity [#solution-4-check-field-case-sensitivity]
...
Incorrect: Typo in unique_key [#incorrect-typo-in-unique_key]
...
Correct: Exact match [#correct-exact-match]
...
Incorrect: Field not in schema [#incorrect-field-not-in-schema]
...
Correct: All fields defined [#correct-all-fields-defined]
...
2. **Compare unique\_key with schema**
