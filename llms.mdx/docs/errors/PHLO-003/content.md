# PHLO-003: Invalid Cron Expression (/docs/errors/PHLO-003)
...
2. **Incorrect field order**
   * Fields must be: minute hour day\_of\_month month day\_of\_week
   * Common mistake: swapping day\_of\_month and month
...
Solution 1: Use standard cron syntax [#solution-1-use-standard-cron-syntax]
...
Solution 2: Test on crontab.guru [#solution-2-test-on-crontabguru]
...
Solution 3: Use common schedules [#solution-3-use-common-schedules]
...
Solution 4: Quote the expression [#solution-4-quote-the-expression]
...
Incorrect: Wrong number of fields [#incorrect-wrong-number-of-fields]
...
Correct: 5 fields [#correct-5-fields]
...
Incorrect: Invalid hour value [#incorrect-invalid-hour-value]
...
Correct: Valid hour value [#correct-valid-hour-value]
...
Incorrect: Invalid step value [#incorrect-invalid-step-value]
...
Correct: Valid step value [#correct-valid-step-value]
...
Cron Field Ranges [#cron-field-ranges]
...
Monthly Schedules [#monthly-schedules]
