# PHLO-004: Validation Failed (/docs/errors/PHLO-004)
...
Solution 1: Inspect the validation failure details [#solution-1-inspect-the-validation-failure-details]
...
Solution 2: Fix schema constraints [#solution-2-fix-schema-constraints]
...
Solution 3: Handle nullable fields [#solution-3-handle-nullable-fields]
...
Solution 4: Clean data before validation [#solution-4-clean-data-before-validation]
...
Incorrect: Schema doesn't account for source data quirks [#incorrect-schema-doesnt-account-for-source-data-quirks]
...
Correct: Schema handles expected variations [#correct-schema-handles-expected-variations]
...
* [PHLO-002: Schema Mismatch](./PHLO-002.md) - unique\_key not found in schema
