# PHLO-008: Infrastructure Error (/docs/errors/PHLO-008)
...
Solution 1: Start Phlo services [#solution-1-start-phlo-services]
...
Solution 2: Check Docker status [#solution-2-check-docker-status]
...
Solution 3: Check service logs [#solution-3-check-service-logs]
...
Solution 4: Verify connection settings [#solution-4-verify-connection-settings]
...
Incorrect: Assuming services are running [#incorrect-assuming-services-are-running]
...
Correct: Check service availability [#correct-check-service-availability]
