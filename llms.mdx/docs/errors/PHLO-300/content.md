# PHLO-300: DLT Pipeline Failed (/docs/errors/PHLO-300)
...
Solution 1: Check the DLT pipeline trace [#solution-1-check-the-dlt-pipeline-trace]
...
Solution 2: Verify source connectivity [#solution-2-verify-source-connectivity]
...
Solution 3: Reset pipeline state [#solution-3-reset-pipeline-state]
...
Solution 4: Check DLT secrets [#solution-4-check-dlt-secrets]
...
Incorrect: No error context in ingestion [#incorrect-no-error-context-in-ingestion]
...
Correct: Source with error handling [#correct-source-with-error-handling]
