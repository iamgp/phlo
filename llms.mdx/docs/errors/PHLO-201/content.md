# PHLO-201: Type Conversion Error (/docs/errors/PHLO-201)
...
Solution 1: Replace with a supported type [#solution-1-replace-with-a-supported-type]
...
Solution 2: Serialize complex fields [#solution-2-serialize-complex-fields]
...
Solution 3: Use Pandera typed fields [#solution-3-use-pandera-typed-fields]
...
Incorrect: Unmappable types [#incorrect-unmappable-types]
...
Correct: Explicit mappable types [#correct-explicit-mappable-types]
