# phlo-superset (/docs/packages/phlo-superset)
...
| `SUPERSET_QUERY_ENGINE`   | unset               | Optional query\_engine capability name used to discover a SQLAlchemy URI |
...
| ------------------------- | -------------------------------------------------------------------------------- |
| **Query Engine Database** | Auto-registered on startup via explicit URI or query\_engine capability metadata |
