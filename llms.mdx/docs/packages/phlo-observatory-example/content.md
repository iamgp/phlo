# phlo-observatory-example (/docs/packages/phlo-observatory-example)
...
ObservatoryExtensionPlugin Base Class [#observatoryextensionplugin-base-class]
...
Creating a Custom Extension [#creating-a-custom-extension]
...
Frontend Not Rendering [#frontend-not-rendering]
