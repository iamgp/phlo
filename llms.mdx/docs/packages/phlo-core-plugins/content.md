# phlo-core-plugins (/docs/packages/phlo-core-plugins)
...
Quality Check Plugins [#quality-check-plugins]
...
Quality Check Usage [#quality-check-usage]
...
Source Connector Plugins [#source-connector-plugins]

| Connector  | Entry Point            | Description                |
| ---------- | ---------------------- | -------------------------- |
| `rest_api` | `phlo.plugins.sources` | Generic REST API connector |

Source Connector Usage [#source-connector-usage]
