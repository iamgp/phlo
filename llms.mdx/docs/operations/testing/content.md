...
Testing Pandera Schemas [#testing-pandera-schemas]
...
Testing Schema Configuration [#testing-schema-configuration]
...
Testing Asset Configuration [#testing-asset-configuration]
...
Advanced Testing Utilities  NEW [#advanced-testing-utilities--new]

Phlo provides powerful testing utilities for fast, local testing without Docker.

Profile-Level Contract Tests [#profile-level-contract-tests]
...
MockIcebergCatalog [#mockicebergcatalog]
...
test_asset_execution [#test_asset_execution]
...
Combining MockIcebergCatalog + test_asset_execution [#combining-mockicebergcatalog--test_asset_execution]
...
Core Service Auto-Configure Validation [#core-service-auto-configure-validation]
...
Testing Asset Materialization [#testing-asset-materialization]
...
CLI Commands  NEW [#cli-commands--new]
...
1\. Test Schema First [#1-test-schema-first]
...
3\. One Assertion Concept Per Test [#3-one-assertion-concept-per-test]
...
4\. Use Fixtures for Test Data [#4-use-fixtures-for-test-data]
...
5\. Mark Integration Tests [#5-mark-integration-tests]
...
Pattern 1: Schema Validation Test [#pattern-1-schema-validation-test]
...
Pattern 2: Constraint Violation Test [#pattern-2-constraint-violation-test]
...
Pattern 3: Field Existence Test [#pattern-3-field-existence-test]
...
Pattern 4: Asset Configuration Test [#pattern-4-asset-configuration-test]
...
* **Pandera Docs**: [https://pandera.readthedocs.io/](https://pandera.readthedocs.io/)
