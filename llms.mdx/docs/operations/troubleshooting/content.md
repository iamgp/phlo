...
Docker Compose Fails [#docker-compose-fails]
...
MinIO Won't Start [#minio-wont-start]
...
Trino Won't Start [#trino-wont-start]
...
Assets Not Showing in UI [#assets-not-showing-in-ui]
...
Asset Materialization Fails [#asset-materialization-fails]
...
Dagster Daemon Not Running [#dagster-daemon-not-running]
...
dbt Models Won't Run [#dbt-models-wont-run]
...
Trino/Query Issues [#trinoquery-issues]
...
Iceberg/Nessie Issues [#icebergnessie-issues]
...
Nessie API Errors [#nessie-api-errors]
...
Inspect Data at Each Step [#inspect-data-at-each-step]
...
Use Dagster Playground [#use-dagster-playground]
...
Query Compiled SQL [#query-compiled-sql]
...
Check Metadata Tables [#check-metadata-tables]
...
* **Trino Docs:** [https://trino.io/docs](https://trino.io/docs)
* **Iceberg Docs:** [https://iceberg.apache.org/docs](https://iceberg.apache.org/docs)
* **Nessie Docs:** [https://projectnessie.org/docs](https://projectnessie.org/docs)
