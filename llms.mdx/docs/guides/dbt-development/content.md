# dbt Development Guide (/docs/guides/dbt-development)
...
Referencing Models [#referencing-models]
...
Custom SQL Tests [#custom-sql-tests]
...
Built-in dbt Macros [#built-in-dbt-macros]
...
Jinja Control Flow [#jinja-control-flow]
...
Basic Incremental Model [#basic-incremental-model]
...
Partitioned Incremental [#partitioned-incremental]
...
3\. CTEs for Readability [#3-ctes-for-readability]
...
4\. Comment Your SQL [#4-comment-your-sql]
...
5\. Keep Models Focused [#5-keep-models-focused]
...
6\. Test Everything Important [#6-test-everything-important]
...
7\. Document Important Logic [#7-document-important-logic]
...
8\. Use Variables for Configuration [#8-use-variables-for-configuration]
...
9\. Leverage Tags [#9-leverage-tags]
...
10\. Version Control Everything [#10-version-control-everything]
