# Plugin Development Guide (/docs/guides/plugin-development)
...
Plugin System Basics [#plugin-system-basics]
...
Declare Capability Requirements [#declare-capability-requirements]
...
Quick Start: Create a Plugin Scaffold [#quick-start-create-a-plugin-scaffold]
...
Example Hook Plugin [#example-hook-plugin]
...
Semantic Layer Providers [#semantic-layer-providers]
...
Asset Provider Plugins [#asset-provider-plugins]
...
Orchestrator Adapter Plugins [#orchestrator-adapter-plugins]
...
Developing a Source Connector Plugin [#developing-a-source-connector-plugin]
...
Complete Example: REST API Source [#complete-example-rest-api-source]
...
Developing a Quality Check Plugin [#developing-a-quality-check-plugin]
...
Complete Example: Business Rule Check [#complete-example-business-rule-check]
...
Use the Plugin [#use-the-plugin-1]
...
Developing a Service Plugin [#developing-a-service-plugin]
...
Service Plugin Class [#service-plugin-class]
...
Register the Plugin [#register-the-plugin-1]
...
1\. Comprehensive Metadata [#1-comprehensive-metadata]
...
2\. Robust Error Handling [#2-robust-error-handling]
...
4\. Comprehensive Testing [#4-comprehensive-testing]
...
To Internal Registry [#to-internal-registry]
...
* GitHub Issues: [https://github.com/iamgp/phlo/issues](https://github.com/iamgp/phlo/issues)
* Documentation: [https://docs.phlo.io](https://docs.phlo.io)
* Community Discord: [https://discord.gg/phlo](https://discord.gg/phlo)
