# Dagster Assets Tutorial (/docs/guides/dagster-assets)
...
Your First Asset [#your-first-asset]
...
Multi-Asset Dependencies [#multi-asset-dependencies]
...
What are Partitions? [#what-are-partitions]
...
Materializing Partitions [#materializing-partitions]
...
Hourly Partitions [#hourly-partitions]
...
Multi-Dimensional Partitions [#multi-dimensional-partitions]
...
Asset Checks and Quality [#asset-checks-and-quality]
...
Data Quality with Pandera [#data-quality-with-pandera]
...
Pattern 1: Dynamic Assets [#pattern-1-dynamic-assets]
...
Pattern 2: Multi-Asset [#pattern-2-multi-asset]
...
Pattern 3: Observable Source Assets [#pattern-3-observable-source-assets]
...
Pattern 4: Asset Factories [#pattern-4-asset-factories]
...
Pattern 5: Retry Logic [#pattern-5-retry-logic]
...
Pattern 6: Asset Versioning [#pattern-6-asset-versioning]
...
Pattern 7: IO Managers [#pattern-7-io-managers]
...
Asset Not Showing in UI [#asset-not-showing-in-ui]
...
Asset Fails to Materialize [#asset-fails-to-materialize]
...
Asset Dependencies Not Working [#asset-dependencies-not-working]
...
Partition Errors [#partition-errors]
...
Slow Asset Materialization [#slow-asset-materialization]
