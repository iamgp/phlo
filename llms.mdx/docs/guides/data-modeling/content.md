# Data Modeling Guide - Bronze, Silver, Gold Architecture (/docs/guides/data-modeling)
...
The Bronze Layer [#the-bronze-layer]
...
What DOESN'T Happen Here [#what-doesnt-happen-here]

* **No business logic** (no "is\_active", "status\_category", etc.)
* **No aggregations** (no GROUP BY)
* **No enrichments** (no calculated fields like "days\_since\_\*")
* **No joins** (single-source transformations only)

Bronze Layer Best Practices [#bronze-layer-best-practices]
...
The Silver Layer [#the-silver-layer]
...
Silver Layer Best Practices [#silver-layer-best-practices]
...
What Happens Here [#what-happens-here-2]
...
Gold Layer Best Practices [#gold-layer-best-practices]
...
Marts Layer Best Practices [#marts-layer-best-practices]
...
Principle 1: Each Layer Has a Clear Purpose [#principle-1-each-layer-has-a-clear-purpose]
...
Principle 2: Progressive Transformation [#principle-2-progressive-transformation]
...
Principle 3: Optimize for Different Users [#principle-3-optimize-for-different-users]
...
Principle 4: Schema Flexibility [#principle-4-schema-flexibility]
...
Pattern 1: Slowly Changing Dimensions (SCD) [#pattern-1-slowly-changing-dimensions-scd]
...
Pattern 2: Snapshot Fact Tables [#pattern-2-snapshot-fact-tables]
...
Pattern 3: Accumulating Snapshot [#pattern-3-accumulating-snapshot]
...
Pattern 4: Event Sourcing [#pattern-4-event-sourcing]
...
Adding Columns (Easy) [#adding-columns-easy]
...
Changing Column Types (Medium) [#changing-column-types-medium]
...
Renaming Columns (Easy) [#renaming-columns-easy]
...
Removing Columns (Easy) [#removing-columns-easy]
