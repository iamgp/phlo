# Plugin Registry (/docs/guides/plugin-registry)



Registry data format [#registry-data-format]
...
RegistryPlugin dataclass [#registryplugin-dataclass]
...
list_registry_plugins [#list_registry_plugins]
