# Capability Primitives and Orchestrator Adapters (/docs/guides/capability-primitives)
...
Why capability primitives [#why-capability-primitives]
...
Core primitives (specs) [#core-primitives-specs]
...
Orchestrator adapters [#orchestrator-adapters]
...
Orchestrator selection [#orchestrator-selection]
...
Catalog entry points (how engines consume them) [#catalog-entry-points-how-engines-consume-them]
