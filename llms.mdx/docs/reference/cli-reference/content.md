...
phlo services init [#phlo-services-init]
...
phlo services start [#phlo-services-start]
...
phlo services exec [#phlo-services-exec]
...
phlo services stop [#phlo-services-stop]
...
phlo services list [#phlo-services-list]
...
phlo services ports [#phlo-services-ports]
...
phlo services add [#phlo-services-add]
...
phlo services remove [#phlo-services-remove]
...
phlo services reset [#phlo-services-reset]
...
phlo services restart [#phlo-services-restart]
...
phlo services status [#phlo-services-status]
...
phlo services logs [#phlo-services-logs]
...
phlo plugin list [#phlo-plugin-list]
...
phlo plugin search [#phlo-plugin-search]
...
phlo plugin install [#phlo-plugin-install]
...
phlo plugin info [#phlo-plugin-info]
...
phlo plugin update [#phlo-plugin-update]
...
phlo plugin create [#phlo-plugin-create]
...
phlo plugin check [#phlo-plugin-check]
...
Opens Dagster UI at [http://localhost:3000](http://localhost:3000)

Workflow Commands [#workflow-commands]

phlo workflow create [#phlo-workflow-create]
...
phlo materialize [#phlo-materialize]
...
Schema Migration Commands [#schema-migration-commands]

phlo schema-migrate export-contract [#phlo-schema-migrate-export-contract]
...
phlo schema-migrate scaffold-yaml [#phlo-schema-migrate-scaffold-yaml]
...
phlo schema-migrate scaffold-yaml-recent [#phlo-schema-migrate-scaffold-yaml-recent]
...
phlo schema-migrate plan/apply/history [#phlo-schema-migrate-planapplyhistory]
...
phlo migrate validate [#phlo-migrate-validate]
...
phlo migrate run [#phlo-migrate-run]
...
phlo migrate list [#phlo-migrate-list]
...
phlo migrate status [#phlo-migrate-status]
...
Logging & Monitoring Commands [#logging--monitoring-commands]
...
phlo branch create [#phlo-branch-create]
...
phlo branch list [#phlo-branch-list]
...
phlo branch merge [#phlo-branch-merge]
...
phlo branch delete [#phlo-branch-delete]
...
phlo branch diff [#phlo-branch-diff]
...
phlo catalog tables [#phlo-catalog-tables]
...
phlo catalog describe [#phlo-catalog-describe]
...
phlo catalog history [#phlo-catalog-history]
...
phlo lineage show [#phlo-lineage-show]
...
phlo lineage export [#phlo-lineage-export]
...
phlo config show [#phlo-config-show]
...
phlo config validate [#phlo-config-validate]
...
phlo env export [#phlo-env-export]
...
phlo validate-schema [#phlo-validate-schema]
...
phlo validate-workflow [#phlo-validate-workflow]
...
Optional Plugin Commands [#optional-plugin-commands]
