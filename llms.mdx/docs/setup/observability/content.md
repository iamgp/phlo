# Observability Guide (/docs/setup/observability)
...
OTLP-First Model [#otlp-first-model]
...
Prometheus (Port 10013) [#prometheus-port-10013]
...
Loki (Port 10014) [#loki-port-10014]
...
Grafana Alloy (Port 10015) [#grafana-alloy-port-10015]
...
Grafana (Port 10016) [#grafana-port-10016]
...
**Note:** Grafana is available at port 10016 by default. Access at [http://localhost:10016](http://localhost:10016).
...
1. Open Grafana: [http://localhost:10016](http://localhost:10016)
...
Failure Sensors [#failure-sensors]
...
No Metrics Appearing [#no-metrics-appearing]

1. Check Prometheus targets: [http://localhost:10013/targets](http://localhost:10013/targets)
   * All targets should show "UP"
   * If "DOWN", check service health: `phlo services status`

2. Check Alloy status: [http://localhost:10015](http://localhost:10015)
