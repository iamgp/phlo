 ...
 * Selecting a table navigates to /data/$schema/$table for URL-driven state.
 */
function DataExplorerLanding() {
  const navigate = useNavigate()
  const branch = 'main' // TODO: integrate with branch selector
      ...
      <aside className="w-72 border-r border-slate-700 bg-slate-800/50 flex flex-col">
        <div className="p-4 border-b border-slate-700">
          ...
          <p className="text-xs text-slate-400 mt-1">
            Browsing branch:{' '}
            <code className="bg-slate-700 px-1 rounded">{branch}</code>
          </p>
        </div>
